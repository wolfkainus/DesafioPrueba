...
class AcountsControllerTest < ActionController::TestCase
  ...
  test "should create acount" do
    assert_difference('Acount.count') do
      post :create, acount: { acount_tipe: @acount.acount_tipe, amount: @acount.amount, balance: @acount.balance, client: @acount.client, date: @acount.date, description: @acount.description }
    end
  ...
  test "should update acount" do
    patch :update, id: @acount, acount: { acount_tipe: @acount.acount_tipe, amount: @acount.amount, balance: @acount.balance, client: @acount.client, date: @acount.date, description: @acount.description }
    assert_redirected_to acount_path(assigns(:acount))
  end
